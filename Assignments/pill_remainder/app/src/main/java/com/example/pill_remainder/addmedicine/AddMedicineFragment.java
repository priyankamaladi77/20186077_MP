...
import com.example.pill_remainder.alarm.RemainderActivity;
import com.example.pill_remainder.alarm.RemainderFragment;
...
import com.example.pill_remainder.views.DayViewCheckBox;
        ...
        public void onClick(View v) {
            ...
            for (int i = 0; i < 7; i++) {
                if (dayOfWeekList[i] && pill_name.length() != 0) {
                    ...
                    intent.putExtra(RemainderFragment.EXTRA_ID, _id);
